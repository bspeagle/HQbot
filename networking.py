#I STOLE THIS FROM ANOTHER HQ BOT (https://github.com/Exaphis/HackQ-Trivia). I'm lazy and didn't feek like doing the plumbing to talk to the socket.
                ...
                if msg.type == aiohttp.WSMsgType.TEXT:
                    ...
                    if "error" in message_data and message_data["error"] == "Auth not valid":
                        ...
                        if message_data["type"] == "question":
                            ...
                            searchHelper.answerQuestion(question_str, answers)
